...
| util | <ul><li>[google-cloud-cli 524.0.0-slim](https://cloud.google.com/sdk/docs/release-notes)</li></ul> | [Dockerfile](https://github.com/ASAP-CRN/wf-common/tree/main/docker/util) | both |
